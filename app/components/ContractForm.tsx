...
export default function ContractForm({ cccd, rawText, onBack }: Props) {
  ...
  const contractTypes: Array<{
    ...
    { id: "dat-coc", label: "Hợp đồng đặt cọc", emoji: "💰", desc: "Hoàn lại cọc" },
  ];

  return (
    <div className="flex gap-6 xl:gap-8">
      {/* Left sidebar: CCCD Preview */}
      ...
      <main className="flex-1 min-w-0 space-y-7">
        ...
        {/* Form Content - Only show when thue-nha or dat-coc selected */}
        ...
        {/* Info for other document types */}
        {!["thue-nha", "dat-coc"].includes(d.loaiHopDong) && (
